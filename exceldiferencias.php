...
<body>
    ...
    $i = 0;
   $sqlDetalleVenta = "SELECT codpro, desprod,factor,(s000+s001+s002+s003+s004+s005+s006+s007+s008+s009+s010+s011+s012+s013+s014+s015+s016+s017+s018) as stocktotal,stopro FROM `producto` WHERE eliminado='0'";
