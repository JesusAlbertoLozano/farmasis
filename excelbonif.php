...
<head>
    ...
    <title>Reporte de productos no activo para compras con stock</title>
...
<body>
    ...
    $i = 0;
   $sqlDetalleVenta = "select * from kardex where tipmov='11' and tipdoc='11' ORDER BY `fecha` DESC ";
        ...
        <table border='1' width="100%" align="center" id="customers">
            ...
            <thead>
                 <tr>
                    <th colspan='30'>
                        <h1>
                         REPORTE DE PRODUCTOS BONIFICADOS KARDEX
                        </h1>
                    </th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                while ($rowDetalleVenta = mysqli_fetch_array($resultDetalleVenta)) {
                    ...
                    $sucursal      = $rowDetalleVenta['sucursal'];
                     $fecha      = $rowDetalleVenta['fecha'];
