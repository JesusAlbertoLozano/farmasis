...
function FnGenerateXmlAndSend($id = 0, $conexion, $send = true) {
    ...
    while ($v = mysqli_fetch_array($resultdetalle_venta, MYSQLI_ASSOC)) {
        ...
        if ($v['prisal'] <= 0) {
            ...
            $v['pripro'] = 0.25 * $v['canpro']; //nuevo modificado rommel  25 de  mayo 2022
        ...
        if ($is_gratuito == true) {
            ...
            $valventa = 0.25; //nuevo modificado rommel  25 de  mayo 2022//nuevo modificado rommel  25 de  mayo 2022
        }
        //==================================================================
        $itemx = array(
            'item' => $k,
