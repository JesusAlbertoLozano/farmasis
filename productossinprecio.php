...
<head>
    ...
    <title>Reporte de productos sin precios</title>
...
<body>
    ...
    $i = 0;
   $sqlDetalleVenta = "SELECT codpro,desprod,factor,stopro,s000,s001,s002,s003,s004,s005,s006,s007,s008,s009,s010,s011,s012,s013,s014,s015,s016,s017,s018,eliminado,preuni,prevta,costre FROM `producto` WHERE preuni='0' and prevta='0' and  costre>'0'  and eliminado='0' ";
        ...
        <table border='1' width="100%" align="center" id="customers">
            ...
            <thead>
                 <tr>
                    <th colspan='30'>
                        <h1>
                         REPORTE DE PRODUCTOS SIN PRECIOS
                        </h1>
                    </th>
                </tr>
                <tr>
            ...
            <tbody>
               ...
               $codbar='';
                ...
                while ($rowDetalleVenta = mysqli_fetch_array($resultDetalleVenta)) {
                    ...
                    $costre    = $rowDetalleVenta['costre'];
                    $preuni    = $rowDetalleVenta['preuni'];
                    $prevta    = $rowDetalleVenta['prevta'];
