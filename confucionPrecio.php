...
<body>
    ...
    $i = 0;
    $sqlDetalleVenta = "SELECT codpro,prevta,prevta2,preuni,preuni2,factor   FROM `producto` WHERE prevta2>0 and prevta<> prevta2";
        ...
        <table border='1' width="100%" align="center" id="customers">
            ...
            <thead>
                 <tr>
                    <th colspan='30'>
                        <h1>
                        REPORTE DE PRODDUCTOS CON PRECIOS DISTINTOS 
                        </h1>
                    </th>
                </tr>
                <tr>
