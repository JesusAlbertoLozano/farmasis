    ...
    <td>
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="633">
            <div align="center"><b><?php if ($val == 1) { ?>NRO DE VENTA ENTRE EL <?php echo $desc; ?> Y EL <?php echo $desc1;
                                                                                                          }
                                                                                                          if ($vals == 2) { ?> FECHAS ENTRE EL <?php echo $dat1; ?> Y EL <?php echo $dat2;
                                                                                                                                                                        } ?></b></div>
          </td>
          <td width="133">
            ...
            ?>
              <table width="100%" border="0" align="center">
                ...
                <tr bgcolor="#77b9f7" height="30">
                  ...
                  <th style="border: solid 1px #2c70af ;color:#fff;font-size: 13px;">
                    <div align="left"><strong> N&ordm; VENTA </strong></div>
                  </th>
                  <th style="border: solid 1px #2c70af ;color:#fff;font-size: 13px;">
                  ...
                  <th style="border: solid 1px #2c70af ;color:#fff;font-size: 13px;">
                    <div align=""><strong>CAN. VEN</strong></div>
                  </th>
                ...
                ?>
                  ...
                  <tr height="40" onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';">
                    ...
                    <td width="30">
                      <div align="CENTER"><?php echo $invnumX ?></div>
                    </td>
                    <td width="30">
