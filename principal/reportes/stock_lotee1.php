...
<!--                                      <input type="button" name="Submit" value="RESUMEN X DIA" onclick="resumen()" class="buscar"/>-->
			...
			<td width="24">
			  ...
			  {
			  ?>
              <a href="stock_lotee.php?val=<?php echo $val?>&vals=<?php echo $vals?>&desc=<?php echo $desc?>&desc1=<?php echo $desc1?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&ck=<?php echo $ck?>&ck1=<?php echo $ck1?>&ckloc=<?php echo $ckloc?>&local=<?php echo $local?>&inicio=<?php echo $inicio?>&registros=<?php echo $registros?>&pagina=<?php echo $pagina-1?>"><img src="../../images/play1.gif" width="100%" height="16" border="0"/> </a>
              <?php }
			  ?></td>
...
<!--                <td width="119">FECHA INICIO</td>
                ...
                <input type="text" name="date2" id="date2" size="12" value="<?php if ($date2 == ""){ echo $date;} else {echo $date2;}?>"/>
                  ...
                  <td width="107"><div align="LEFT">DESCRIPCION</div></td>
                  <td width="340"><label>
                  <input name="desc" id="desc" type="text" value="<?php echo $desc?>" id="desc" size="90" onKeyUp="this.value = this.value.toUpperCase();" <?php if ($nombre_local <> 'LOCAL0'){?> disabled="disabled"<?php }?>/>
                  </label>
                  </td>
                <td width="159">
