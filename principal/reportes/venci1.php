...
<body>
  ...
  ?>
    <iframe src="venci2.php?val=<?php echo $val ?>&mes=<?php echo $mes ?>&year=<?php echo $year ?>&ckvencidos=<?php echo $ckvencidos ?>&resumen=<?php echo $resumen ?>&local=<?php echo $local ?>" name="marco" id="marco" width="100%" height="430" scrolling="Automatic" frameborder="0" allowtransparency="0">
    </iframe>
  <?php }
  ?>
</body>
