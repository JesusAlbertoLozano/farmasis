                ...
                <body>
                    ...
                    <script language="JavaScript">
                        ...
                        function validarTipoDoc()
                        {
                            ...
                            if (f.from.value == "")
                            {
                                alert("Ingrese un n̼mero inicial");
                                f.from.focus();
                                return;
                            }
                            if (f.until.value == "")
                            {
                                alert("Ingrese un n̼mero final");
                                f.until.focus();
                                return;
                            }
                            document.form1.val.value = "";
                           ...
                           function desdelivery() {
                             ...
                             if (f.delivery.checked == true) {
                                 ...
                                 f.deliveryWeb.disabled = true;
                                 f.ckprod.disabled = true;
                                 } else {

                      
                                     f.deliveryWeb.disabled = false;
                                      f.ckprod.disabled = false;
    
                              }
                          }
                    
                        function desdeliveryWeb() {
                          var f = document.form1;
                         if (f.deliveryWeb.checked == true) {
...
////////////////////////////
                            ...
                            <td><b><u>REPORTE DE VENTAS DIARIAS</u></b>
                                <form id="form1" name="form1" method = "post" action="">
                                    <table class="tablarepor"  width="100%" border="0">
                                        <tr bgcolor= "#ececec">
                                            <td width="110" align="left" class="LETRA">SALIDA</td>
                                            <td width="172">
                                            ...
                                            <td width="88"><div align="right" class="LETRA">LOCAL</div></td>
                                            <td  >
                                            ...
                                            <td><input name="ckloc" type="checkbox" id="ckloc" value="1" checked="checked" />
                                                <label for="ckloc" class="LETRA">  Mostrar Local </label>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             
                                                <input name="delivery" type="checkbox" id="delivery" value="1" <?php if ($delivery == 1) { ?>checked="checked" <?php } ?> <?php if ($deliveryWeb == 1) { ?>disabled="disabled" <?php } ?> onclick="desdelivery()" />
                                            ...
                                            <td >
                                                ...
                                                <input name="deliveryWeb" type="checkbox" id="deliveryWeb" value="1" <?php if ($deliveryWeb == 1) { ?>checked="checked" <?php } ?> <?php if ($delivery == 1) { ?>disabled="disabled" <?php } ?> onclick="desdeliveryWeb()" />
                                                <label for="deliveryWeb" class="LETRA"> Delivery Web </label>
                                                <input name="ckprod" type="checkbox" id="ckprod" value="1" <?php if ($ckprod == 1) { ?>checked="checked"<?php } ?><?php if ($delivery == 1) { ?>disabled="disabled" <?php } ?><?php if ($deliveryWeb  == 1) { ?>disabled="disabled" <?php } ?>onclick="desab()"/>
                    ...
                    <!--			<td width="24">
                                        ...
                                        <tr bgcolor= "#ececec">
                                            <td width="119" class="LETRA">N. I. INICIAL</td>
                                            ...
                                            <td ><div align="right" class="LETRA">N. I. FINAL</div></td>
                                            ...
                                            <td  width="220"><input name="val" type="hidden" id="val" value="1" />
                                                ...
                                                <input type="button" name="Submit22" value="Imprimir" onClick="self.location.href = 'ventas_dia2_3.php?ventas_dia2_3.php?val=<?php echo $val ?>&vals=<?php echo $vals ?>&valTipoDoc=<?php echo $valTipoDoc ?>&desc=<?php echo $desc ?>&desc1=<?php echo $desc1 ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&tipoDoc=<?php echo $tipoDoc ?>&from=<?php echo $from ?>&until=<?php echo $until ?>&report=<?php echo $report ?>&ck=<?php echo $ck ?>&ck1=<?php echo $ck1 ?>&ck2=<?php echo $ck2 ?>&ckloc=<?php echo $ckloc ?>&ckprod=<?php echo $ckprod ?>&local=<?php echo $local ?>&delivery=<?php echo $delivery ?>&deliveryWeb=<?php echo $deliveryWeb ?>'" class="imprimir"/>
                                        ...
                                        <tr bgcolor= "#ececec">
                                            ...
                                            <td ><div align="right" class="LETRA">FECHA FINAL</div></td>
                                            <td width="133">
                                        ...
                                        <tr bgcolor= "#ececec">
                                            <td width="119" class="LETRA">TIPO DOC</td>
                                            <td width="90">
                                            ...
                                            <td align="right" class="LETRA">DESDE</td>
                                            <td width="34"><input name="from" type="text" id="from" size="8" onkeypress="return acceptNum(event)" maxlength="10" value="<?php echo $from ?>"/>
                                            ...
                                            <td width="199">
                                                ...
                                                <label for="ck2" class="LETRA"> Mostrar Lista detallada por N&ordm;</label> </td>
