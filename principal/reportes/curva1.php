                                ...
                                <form id="form1" name="form1" method = "post" action="">
                                    <table class="tablarepor" width="100%" border="0">
                                        <tr>
                                            ...
                                            <td width="70" class="LETRA"><div align="right">BUSCAR POR</div></td>
                                            <td width="180">
                                        ...
                                        <tr>
                                            ...
                                            <!--<td width="23">&nbsp;</td>-->
                                            <td width="106" class="LETRA"><div align="right">FECHA FINAL</div></td>
                                            <td width="133">
                                            ...
                                            <td  colspan="4" width="250" align="right"><input name="val" type="hidden" id="val" value="1" />
                                                ...
                                                if ($local != '' && $local != 'all') {
                                                    ?>
                                                    <input type="button" name="prepedido" value="Prepedido" onclick="generarPrepedido()" class="grabar"/>
                                                    <?php
                                                }
                                                ?>
