...
<!--			<td width="50">RESUMEN			</td>
			...
			<td width="23">
			  ...
			  {
			  ?>
              <a href="venci2.php?val=<?php echo $val?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&resumen=<?php echo $resumen?>&local=<?php echo $local?>&inicio=<?php echo $inicio?>&registros=<?php echo $registros?>&pagina=<?php echo $pagina-1?>"><img src="../../images/play1.gif" width="16" height="16" border="0"/> </a>
              <?php }
			  ?></td>
			<td width="27"><?php if(($pagina + 1)<=$total_paginas) 
			  {
			  ?>
              <a href="venci2.php?val=<?php echo $val?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&resumen=<?php echo $resumen?>&local=<?php echo $local?>&inicio=<?php echo $inicio?>&registros=<?php echo $registros?>&pagina=<?php echo $pagina+1?>"> <img src="../../images/play.gif" width="16" height="16" border="0"/> </a>
              <?php }
			  ?></td>
          </tr>
        </table>
