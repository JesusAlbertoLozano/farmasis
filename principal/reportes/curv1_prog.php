  ...
  <tr>
    <td><table width="926" border="0" align="center">
      <tr>
		...
		<a href="curv2.php?val=<?php echo $val?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&local=<?php echo $local?>&inicio=<?php echo $inicio?>&registros=<?php echo $registros?>&pagina=<?php echo $pagina?>&tot_pag=<?php echo $total_paginas?>&ord=1&tip=1"><img src="down_enabled.gif" width="7" height="9" border="0" /></a>
		MONTO
		<a href="curv2.php?val=<?php echo $val?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&local=<?php echo $local?>&inicio=<?php echo $inicio?>&registros=<?php echo $registros?>&pagina=<?php echo $pagina?>&tot_pag=<?php echo $total_paginas?>&ord=0&tip=1"><img src="up_enabled.gif" width="7" height="9" border="0"/></a>
		</strong></div></td>
