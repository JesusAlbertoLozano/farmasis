...
//	  $sql="SELECT codcli,desprod,pcostouni,costre,margene,prevta,preuni,factor,codmar,blister,preblister FROM producto where codcli = '$search'";
	  ...
	  ?>
        <table width="100%" border="0" align="center">
            <tr bgcolor="#7fb2d3">
        <th width="180"><strong>CLIENTE</strong></th>
        <th width="100" align="center"><strong>DNI</strong></th>
<!--        <th width="89"><div align="right"><strong>P. COSTO</strong></div></th>
	<th width="71"><div align="right"><strong>MARGEN % </strong></div></th>
        ...
        <th width="40"><div align="left"><strong>PUNTOS ACOMULADOS. </strong></div></th>
        <th width="40"><div align="left"><strong>PUNTOS A DESCONTAR. </strong></div></th>
        <th width="80"><div align="center"><strong>DESCRIPCION</strong></div></th>
        <?php IF ($count == 0){?>
        <th width="68"><div align="center"><strong> DESCONTAR</strong></div></th>
        <?php }else{?>
        <th width="68"><div align="center"><strong> GRABAR</strong></div></th>
        <?php }?>
      </tr>
	  ...
	  ?>
       ...
       <thead id="Topicos_Cabecera_Datos">
               ...
               <tbody id="gtnp_Listado_Datos">
                   ...
                   $i = 1 ;
                   if ($codclire == ""){
                   	  $sql="SELECT codpun,fecha,usecod,codclic,despunto,pdescuento,estado from puntos as P  WHERE  P.codclic ='$search' ORDER BY fecha " ;
                   }else{	  
                         $sql="SELECT codpun,fecha,usecod,codclic,despunto,pdescuento,estado from puntos as P  WHERE  P.codclic ='$codclire' ORDER BY fecha" ;
                   }
//                   if ($codclire == ""){
//                       echo $sql ."letra";
//                        }else{
