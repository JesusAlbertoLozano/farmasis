								...
								<table width="930" border="1" align="center" cellpadding="0" cellspacing="0" scrolling="Automatic">
									<thead>
										<tr>
											...
											<?php } ?>
											<th width="45"><div align="center"><strong>COSTO UNITARIO</strong></div></th>
									...
									?>
												<tr>
													<td colspan="<?php if ($detalle=='det') { echo '5'; } else { echo '3';}  ?>" width="32" align="right"><b>Total <?php echo $labAnt ?>:</b></td>
									...
									?>
												...
												<tr style="font-size:13px;font-weight:boldest;background-color:#ddddff">
													<td colspan="<?php if ($detalle=='det') { echo '5'; } else { echo '3';}  ?>" width="32" align="left" style="font-size:15px"><b>Total General:</b></td>
