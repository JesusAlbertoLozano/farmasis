...
<table width="930" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	if ($val == 1){
		if ($local == 'all'){
			if ($ckloc == 1){
			$sql="SELECT usecod,sucursal FROM venta where nrovent between '$desc' and '$desc1' and estado = '0' and invtot <> '0' and estado2 <> '1' group by usecod,sucursal";}
			else{
			$sql="SELECT usecod FROM venta where nrovent between '$desc' and '$desc1' and estado = '0' and invtot <> '0' and estado2 <> '1' group by usecod";}}
		else{
		$sql="SELECT usecod FROM venta where nrovent between '$desc' and '$desc1' and sucursal = '$local' and invtot <> '0' and estado = '0' and estado2 <> '1' group by usecod";}}
	if ($vals == 2){
		if ($local == 'all'){
			if ($ckloc == 1){
		...
		$sql="SELECT usecod FROM venta where invfec between '$date1' and '$date2' and sucursal = '$local' and invtot <> '0' and estado = '0' and estado2 <> '1' group by usecod order by nrovent";}}
	if ($valTipoDoc == 1){
		if ($local == 'all'){
			if ($ckloc == 1){
	...
	<table width="926" border="0" align="center">
      <?php while ($row = mysqli_fetch_array($result)){
		...
		if ($val == 1){
			if ($local == 'all'){
				if ($ckloc == 1){
				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and nrovent between '$desc' and '$desc1' and estado = '0' and sucursal = '$sucurs' and estado2 <> '1' order by sucursal";}
				else{
				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and nrovent between '$desc' and '$desc1' and estado = '0' and estado2 <> '1' order by sucursal";}}
			else{
			$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and nrovent between '$desc' and '$desc1' and sucursal = '$local' and estado2 <> '1' and estado = '0'";}}
...
<table width="930" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	if ($val == 1){
		if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent FROM venta where nrovent between '$desc' and '$desc1' and estado = '0' and estado2 <> '1' and invtot <> '0'";
		}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent FROM venta where nrovent between '$desc' and '$desc1' and sucursal = '$local' and estado = '0' and estado2 <> '1' and invtot <> '0'";
		}
	}
	if ($vals == 2){
		if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent FROM venta where invfec between '$date1' and '$date2' and estado = '0' and invtot <> '0' and estado2 <> '1' order by sucursal,invfec,hora  ";}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent FROM venta where invfec between '$date1' and '$date2' and sucursal = '$local' and invtot <> '0' and estado2 <> '1' and estado = '0'  order by sucursal,invfec,hora";
		}
	}
	if ($valTipoDoc == 1){
		if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent FROM venta where correlativo between '$from' and '$until'  and tipdoc='$tipoDoc' and estado = '0' and estado2 <> '1' and invtot <> '0' order by sucursal, nrovent  ";}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent FROM venta where correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and sucursal = '$local' and estado2 <> '1' and invtot <> '0' and estado = '0'  order by sucursal, nrovent";
		}
	}		
	$zz = 0;
	$i  = 0;
