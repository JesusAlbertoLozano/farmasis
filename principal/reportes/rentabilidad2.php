            ...
            if ($det == 1) {
                ...
                <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" id="customers">
                    ...
                    <tr>
                        ...
                        <th ><div align="center"><strong>CODIGO</strong></div></th>
                        <th ><div align="left"><strong>PRODUCTO</strong></div></th>
                        <?php if ($marca == 'all') { ?>
                            <th ><div align="left"><strong>MARCA</strong></div></th>
                        <?php } ?>
                        <th ><div align="CENTER"><strong>FACTOR</strong></div></th>
                        <th ><div align="right"><strong>CAJAS Y UNIDADES</strong></div></th>
                        <th ><div align="right"><strong>MONTO VENTA</strong></div></th>
                        <th ><div align="right"><strong>COSTO PROMEDIO</strong></div></th>
                        <th ><div align="right"><strong>RENTABILIDAD</strong></div></th>
                        <th ><div align="right"><strong>% RENTABILIDAD</strong></div></th>
...
*/
                                ...
                                $Sumgenpripro += $sumpripro;
                                $Sumgenpcosto += $sumpcosto;
                                ...
                                <tr height="25"  <?php if ($datDSDe2) { ?> bgcolor="#ff0000"<?php } else { ?>onmouseover="this.style.backgroundColor = '#FFFF99';this.style.cursor = 'hand';" onmouseout="this.style.backgroundColor = '#ffffff';"<?php } ?>>
                                    ...
                                    <td ><div align="left"><?php echo $product ?></div></td>
<?php if ($marca == 'all') { ?>
                                        <td ><?php echo $destab ?>
                                        </td>
                                    <?php } ?>
                                    ...
                                    <td ><div align="right"><?php echo $numero_formato_frances = number_format($sumpripro, 2, '.', ' '); ?></div></td>


                                    <td ><div align="right"><?php echo $numero_formato_frances = number_format($sumpcosto, 2, '.', ' '); ?></div></td>
                                    <td ><div align="right"><?php echo $numero_formato_frances = number_format($rentabilidad, 2, '.', ' '); ?> </div></td>
                                    <td ><div align="right"><?php echo $numero_formato_frances = number_format($porcentaje, 2, '.', ' '); ?> %</div></td>
                                </tr>
                                <?php
                            } /////CIERRO EL WHILE
                            ?>
                            <tr bgcolor="#dedeca">
                                ...
                                <?php } ?>
                                <td ><div align="right"><?php echo $numero_formato_frances = number_format($Sumgenpripro, 2, '.', ' '); ?></div></td>
                                <td ><div align="right"><?php echo $numero_formato_frances = number_format($Sumgenpcosto, 2, '.', ' '); ?></div></td>
                                <td ><div align="right"><?php echo $numero_formato_frances = number_format($trentabilidad, 2, '.', ' '); ?></div></td>
                                <td ><div align="right"><?php echo $numero_formato_frances = number_format($tporcentaje, 2, '.', ' '); ?> %</div></td>

                            </tr>
                            <?php
                        } /////CIERRO EL IF DE LA CONSULTA
                        else {
                            ?> <td colspan="8"> <div class="siniformacion">
                                    <center>
                ...
                <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" id="customers">
                    <tr>
                        ...
                        <th ><div align="left"><strong>MARCA</strong></div></th>
                        <th ><div align="right"><strong>MONTO VENTA</strong></div></th>
                        <th ><div align="right"><strong>COSTO VENTA</strong></div></th>
                        <th ><div align="right"><strong>RENTABILIDAD</strong></div></th>
                        <th ><div align="right"><strong>% RENTABILIDAD</strong></div></th>
                    </tr>
                    <tr>
                        ...
                        if (mysqli_num_rows($result1)) {
                            ...
                            ?><td colspan="6"> <div class="siniformacion">
                                    <center>
                                        No se logro encontrar informacion con los datos ingresados
                                    </center>
                                </div></td>
