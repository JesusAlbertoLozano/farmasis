  ...
  <tr>
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="260">
		<div align="center"><strong>FECHA: <?php echo date('d/m/Y');?> - HORA : <?php echo $hour;?>:<?php echo $min;?> <?php echo $hor?></strong></div></td>
      </tr>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="100%" border="0" align="center" id="customers">
        ...
        <th width="321"><div align="center"><strong>PRODUCTO </strong></div></th>
         <th ><div align="left"><strong>FACTOR </strong></div></th>
        <th width="169"><div align="left"><strong>MARCA</strong></div></th>
        <th width="169"><div align="center"><strong>PRIN. ACTIVO</strong></div></th>
        	<?php if($nlicencia > 1) {?>
        <th width="169"><div align="center"><strong>STOCK ALM</strong></div></th>
        	<?php }?>
        <th width="68">
        ...
        <th width="70"><div align="CENTER"><strong>STOCK ACTUAL</strong></div></th>
        <?php if ($TipBusk <>1) { ?>
        <th width="50"><div align="CENTER" class='Estilo1'><strong>COMPRA SUGERIDA</strong></div></th>
        <?php } ?>
                <th width="70"><div align="CENTER"><strong>COSTO DE RESPOSICION</strong></div></th>

        <th width="77"><div align="center"><strong>% DEL TOTAL</strong></div></th>
        <th width="78"><div align="center"><strong>TOTAL DEL % </strong></div></th>
      </tr>
<?php
if ($tip == "")
{
	...
	while ($row = mysqli_fetch_array($result)){
		...
		$factor        = $row1['factor'];
			...
			$sumcantidadAux = $sumcantidad;
                ...
                if ($Tabla <> "0")
                {
                    $sql1="SELECT desprod,codmar,$Tabla,factor, s000,costre,codfam FROM producto where codpro = '$codpro'";
                }
                else
                {
                    $sql1="SELECT desprod,codmar,stopro,factor, s000,costre,codfam FROM producto where codpro = '$codpro'";
                }
	...
	?>
	 <tr height="25"  <?php if(isset($datDSDe2)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
            ...
            <td width="169" align="center"><?php echo $div1." <strong>C</strong>" ." ". $UNI1;?></td>
            	...
            	<?php } ?>
            <td width="68"><div align="center"><?php echo $sum?></div></td>
            <td width="87" <?php if ($TipBusk == 1) { ?>class='Estilo1'><?php } ?><div align="left"><?php echo $sumcantidad1?></div>
            </td>
            <td width="58"><div align="left"><?php echo $StockActual22;?></div></td>
             <?php if ($TipBusk <>1) { ?>
            <td width="58"><div align="left"><?php echo "<p class='Estilo1'>$StockK</p>";?></div></td>
            <?php } ?>
            
            <td width="77"><div align="center"><?php echo number_format($repo, 2, '.', ' ');;?> </div></td>
            <td width="78"><div align="center"><?php echo number_format($sumporc, 2, '.', ' ');?> %</div></td>
            <td width="78"><div align="center"><?php echo number_format($sumporc, 2, '.', ' ');?> %</div></td>
          </tr>
	<?php 
						if ($factorX ==1 ) {
