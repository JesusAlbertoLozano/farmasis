...
$date2 = fecha1($dat2);
	...
	if ($deliveryWeb == 1) {
	    ...
	    $filtroDeliveryWeb = "and deliveryWeb='$deliveryWeb' ";
	    
	}
	
	echo $deliveryWeb .  $filtroDeliveryWeb;
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	if ($val == 1){
		...
		if ($local == 'all'){
			if ($ckloc == 1){
			$sql="SELECT usecod,sucursal FROM venta where invnum between '$desc' and '$desc1' and delivery='$delivery' and estado = '0' and invtot <> '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod,sucursal";}
			else{
			$sql="SELECT usecod FROM venta where invnum between '$desc' and '$desc1' and delivery='$delivery' and estado = '0' and invtot <> '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod";}
		}
		else{
		    $sql="SELECT usecod FROM venta where invnum between '$desc' and '$desc1' and sucursal = '$local' and delivery='$delivery'  and invtot <> '0' and estado = '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod order by usecod";
	...
	if ($vals == 2){
	    if ($delivery == 1) {
    		if ($local == 'all'){
    			if ($ckloc == 1){
    			$sql="SELECT usecod,sucursal FROM venta where invfec between '$date1' and '$date2' and delivery='$delivery' and invtot <> '0' and estado = '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod,sucursal order by nrovent";}
    			else{
    			$sql="SELECT usecod FROM venta where invfec between '$date1' and '$date2' and estado = '0' and delivery='$delivery'  and invtot <> '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod order by nrovent";}}
    		else{
    		    $sql="SELECT usecod FROM venta where invfec between '$date1' and '$date2' and sucursal = '$local' and delivery='$delivery'  and invtot <> '0' and estado = '0' and estado2 <> '1'  $filtroDeliveryWeb group by usecod order by usecod";
    		}
	    }else{
	        if ($local == 'all'){
    			if ($ckloc == 1){
	...
	if ($valTipoDoc == 1){
		...
		if ($local == 'all'){
			if ($ckloc == 1){
			$sql="SELECT usecod,sucursal FROM venta where correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and delivery='$delivery'  and invtot <> '0' and estado = '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod,sucursal order by sucursal, nrovent";}
			else{
			$sql="SELECT usecod FROM venta where correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and delivery='$delivery'  and estado = '0' and invtot <> '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod order by sucursal, nrovent";}}
		else{
		
		    $sql="SELECT usecod FROM venta where correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and delivery='$delivery'   and sucursal = '$local' and invtot <> '0' and estado = '0' and estado2 <> '1' $filtroDeliveryWeb group by usecod order by sucursal, nrovent";
      ...
      <?php while ($row = mysqli_fetch_array($result)){
		...
		if ($valTipoDoc == 1){
		    if ($delivery == 1) {
    			if ($local == 'all'){
    				if ($ckloc == 1){
    					$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and estado = '0' and sucursal = '$sucurs' and estado2 <> '1' $filtroDeliveryWeb order by sucursal";}
    				else{
    				    ...
    				    $sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and sucursal = '$local' and estado = '0' and estado2 <> '1' $filtroDeliveryWeb  order by sucursal";
    			}
		    }else{
		        if ($local == 'all'){
    				if ($ckloc == 1){
    					$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and estado = '0' and sucursal = '$sucurs' and estado2 <> '1'  $filtroDeliveryWeb order by sucursal";}
    				else{
    					$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and estado = '0' $filtroDeliveryWeb  order by sucursal";
    				    }
    		...
    		if ($vals == 2){
    		    if ($delivery == 1) {
        			if ($local == 'all'){
        				if ($ckloc == 1){
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and invfec     between '$date1' and '$date2' and estado = '0' and sucursal = '$sucurs' and estado2 <> '1' $filtroDeliveryWeb order by sucursal";}
        				else{
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and invfec     between '$date1' and '$date2' and estado = '0' and estado2 <> '1' $filtroDeliveryWeb order by sucursal";
        				    
        				}
        			    
        			}
        			else{
        			    $sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and invfec     between '$date1' and '$date2' and sucursal = '$local' and estado2 <> '1' and estado = '0' $filtroDeliveryWeb ";
        			    
        			}
    		    }else{
    		        if ($local == 'all'){
        				if ($ckloc == 1){
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and invfec   between '$date1' and '$date2' and estado = '0' and sucursal = '$sucurs' and estado2 <> '1' $filtroDeliveryWeb order by sucursal";}
        				else{
    		...
    		if ($val == 1){
    		    if ($delivery == 1) {
        			if ($local == 'all'){
        				if ($ckloc == 1){
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and invnum     between '$desc'  and '$desc1'  and estado = '0' and sucursal = '$sucurs' and estado2 <> '1' $filtroDeliveryWeb order by sucursal";}
        				else{
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and invnum     between '$desc'  and '$desc1'  and estado = '0' and estado2 <> '1'  $filtroDeliveryWeb order by sucursal";}}
        			else{
        			    $sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and invnum     between '$desc'  and '$desc1'  and sucursal = '$local' and estado2 <> '1' and estado = '0' $filtroDeliveryWeb";
    		        ...
    		        if ($local == 'all'){
        				if ($ckloc == 1){
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and invnum     between '$desc'  and '$desc1'  and estado = '0' and sucursal = '$sucurs' and estado2 <> '1' $filtroDeliveryWeb  order by sucursal";}
        				else{
        				$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and invnum     between '$desc'  and '$desc1'  and estado = '0' and estado2 <> '1' $filtroDeliveryWeb 	 order by sucursal";}}
        			else{
        			    $sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and invtot <> '0' and invnum     between '$desc'  and '$desc1'  and sucursal = '$local' and estado2 <> '1' and estado = '0' $filtroDeliveryWeb  ";
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	if ($val == 1){
	    if ($delivery == 1) {
		if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invnum between '$desc' and '$desc1' and delivery='$delivery'  and estado = '0' and estado2 <> '1' and invtot <> '0' $filtroDeliveryWeb";
		}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invnum between '$desc' and '$desc1' and sucursal = '$local' and delivery='$delivery'  and estado = '0' and estado2 <> '1' and invtot <> '0' $filtroDeliveryWeb";
		}
	    }else{
    	        if ($local == 'all'){
    			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invnum between '$desc' and '$desc1' and estado = '0' and estado2 <> '1' and invtot <> '0' $filtroDeliveryWeb";
    		}
    		else{
    			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invnum between '$desc' and '$desc1' and sucursal = '$local' and estado = '0' and estado2 <> '1' and invtot <> '0' $filtroDeliveryWeb";
    		}
	    }
	...
	if ($vals == 2){
	    if ($delivery == 1) {
		if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invfec between '$date1' and '$date2' and estado = '0' and invtot <> '0' and delivery='$delivery'  and estado2 <> '1' $filtroDeliveryWeb order by sucursal,invfec,hora  ";}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invfec between '$date1' and '$date2' and sucursal = '$local' and invtot <> '0' and delivery='$delivery'  and estado2 <> '1' and estado = '0' $filtroDeliveryWeb  order by sucursal,invfec,hora";
		}
	    }else{
	        if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invfec between '$date1' and '$date2' and estado = '0' and invtot <> '0' and estado2 <> '1' $filtroDeliveryWeb order by sucursal,invfec,hora  ";}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where invfec between '$date1' and '$date2' and sucursal = '$local' and invtot <> '0' and estado2 <> '1' and estado = '0' $filtroDeliveryWeb  order by sucursal,invfec,hora";
		}
	    }
	}
	if ($valTipoDoc == 1){
	    ...
	    if ($delivery == 1) {
		if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where correlativo between '$from' and '$until'  and tipdoc='$tipoDoc' and estado = '0' and estado2 <> '1' and delivery='$delivery'  and invtot <> '0' $filtroDeliveryWeb order by sucursal, nrovent  ";}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and sucursal = '$local' and estado2 <> '1' and delivery='$delivery'  and invtot <> '0' and estado = '0' $filtroDeliveryWeb  order by sucursal, nrovent";
		}
	    }else{
	        	if ($local == 'all'){
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where correlativo between '$from' and '$until'  and tipdoc='$tipoDoc' and estado = '0' and estado2 <> '1' and invtot <> '0' $filtroDeliveryWeb order by sucursal, nrovent  ";}
		else{
			$sql="SELECT invnum,usecod,nrofactura,forpag,val_habil,invtot,sucursal,hora,nrofactura, nrovent,invfec FROM venta where correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and sucursal = '$local' and estado2 <> '1' and invtot <> '0' and estado = '0' $filtroDeliveryWeb  order by sucursal, nrovent";
		}
	    }
	}	
