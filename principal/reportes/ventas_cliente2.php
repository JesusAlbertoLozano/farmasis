...
?>
	...
	?>
  <tr height="25"  <?php if(isset($date2d3)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
	...
	while ($row1 = mysqli_fetch_array($result1)){
		...
		$i++;
	?>
	<tr height="25"  <?php if(isset($date2da)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" id="customers">
	...
	$sum_pvta  = 0;
		...
		$i++;
	?>
  <tr height="25"  <?php if(isset($date2asd)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
...
<table width="1071" border="1" align="center" cellpadding="0" cellspacing="0" id="customers">
	...
	$sum_pvta  = 0;
		...
		$i++;
	?>
  <tr height="25"  <?php if(isset($date2asda)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
...
<table width="1020" border="1" align="center" cellpadding="0" cellspacing="0" id="customers">
	...
	while ($row1 = mysqli_fetch_array($result1)){
		...
		$i++;
	?>
<tr height="25"  <?php if(isset($date2adsas)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" id="customers">
	...
	while ($row1 = mysqli_fetch_array($result1)){
		...
		$i++;
	?>
  <tr height="25"  <?php if(isset($date2w)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
    <td width="37"><?php echo $i;?></td>
	<td width="242"><?php echo $client?></td>
