		    ...
		    if ($delivery == 1) {
    			if ($local == 'all'){
    				if ($ckloc == 1){
    					...
    					$sql1="SELECT invnum,forpag,val_habil,invtot,sucursal,hora FROM venta where usecod = '$usecod' and delivery='$delivery' and invtot <> '0' and correlativo between '$from' and '$until' and tipdoc='$tipoDoc' and estado = '0' $filtroDeliveryWeb order by sucursal";
    				    }
