...
//                        }
                ...
                <table width="100%" border="0" align="center">
                    <tr>
            <th width="40"><div align="left"><strong>SUCURSAL   </strong></div></th>
            <th width="50"><div align="left"><strong>COD. PRODUCTO  </strong></div></th>
            <th width="70"><div align="left"><strong>PRODUCTO</strong></div></th>
            <th width="55"><div align="left"><strong>MARCA</strong></div></th>
            <!--<th width="50"><div align="left"><strong>FECHA</strong></div></th>-->
            <th ><div align="left"><strong>STOCK</strong></div></th>
            <th ><div align="left"><strong>N. LOTE</strong></div></th>
            <th ><div align="left"><strong>FEVen</strong></div></th>
		...
		$UNI2 = ($stopro-($div2*$factor));
				...
				$nombre	= $row3["nombre"];
					...
					?>
                               	  <tr height="25"  <?php if(isset($datDSDe2)){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
                <td width="150"><?php echo $sucur;?></td>
                <td width="120"><?php echo $codpro;?></td>
                <td   width="160"><div align="left"><?php echo $producto;?></div></td>
                <td  width="150"><div align="left"><?php echo $marca;?></div></td>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="100%" border="0" align="center" id="customers">
            <tr>
        <th  width="<?php if ($doc == 1){?>160<?php }elseif ($doc == 2){?>160<?php }elseif ($doc == 3){?>10000<?php }else{?>0<?php }?>"><div align="left"><strong>SUCURSAL </strong></div></th>
        <th  width="<?php if ($doc == 1){?>160<?php }elseif ($doc == 2){?>160<?php }elseif ($doc == 3){?>10000<?php }else{?>0<?php }?>"><div align="left"><strong>CODIGO PRO</strong></div></th>
        <th  width="<?php if ($doc == 1){?>160<?php }elseif ($doc == 3){?>21000<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 1){echo "<strong>PRODUCTO</strong>";}elseif ($doc == 3){echo "<strong>PRODUCTO</strong>";}?></div></th>
        <th  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 3){?>21000<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>MARCA</strong>";}elseif ($doc == 3){echo "<strong>MARCA</strong>";}?></div></th>
        <th  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 1){?>134<?php }elseif ($doc == 3){?>21000<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>STOCK (POR LOTE)</strong>";}elseif ($doc == 1){echo "<strong>STOCK (POR LOTE)</strong>";}elseif ($doc == 3){echo "<strong> STOCK (POR LOTE) </strong>";}?></div></th>
        <th  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 1){?>134<?php }elseif ($doc == 3){?>21000<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>FECHA VENCIMIENTO</strong>";}elseif ($doc == 1){echo "<strong>FECHA VENCIMIENTO</strong>";}elseif ($doc == 3){echo "<strong> FECHA VENCIMIENTO </strong>";}?></div></th>
        <th  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 1){?>134<?php }elseif ($doc == 3){?>-1<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>STOCK (ARCH. PRODUCTO)</strong>";}elseif ($doc == 1){echo "<strong>STOCK (ARCH. PRODUCTO)</strong>";}?></div></th>
        <th  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 1){?>134<?php }elseif ($doc == 3){?>-1<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>N&ordm;  LOTE</strong>";}elseif ($doc == 1){echo "<strong>N&ordm;  LOTE</strong>";}?></div></th>
        <th  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 1){?>134<?php }elseif ($doc == 3){?>-1<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>VENCIMIENTO</strong>";}elseif ($doc == 1){echo "<strong>VENCIMIENTO</strong>";}?></div></th>
      </tr>
      <?php while ($row = mysqli_fetch_array($result)){
		...
		$UNI2 = ($stopro-($div2*$factor));
		  ...
		  <?php }}?>
                ...
                <td width="140" align="CENTER"> <?php if ($doc == 2){echo $div2."C" ." ". $UNI2." "."unid";}elseif ($doc == 1){echo $div2."C" ." ". $UNI2." "."unid";}elseif ( $doc == 3){echo $div2."C" ." ". $UNI2." "."unid";} ?></td>
                                <td width="134" align="right"> <?php if ($doc == 2){echo $venc;}elseif ($doc == 1){echo $venc;}elseif ( $doc == 3){echo $venc;} ?></td>
                <td width="134" align="CENTER"> <?php if ($doc == 2){echo $div1."C" ." ". $UNI1." "."unid";}elseif ($doc == 1){echo $div1."C" ." ". $UNI1." "."unid";}?></td>
...
<!--                <td width="134"><?php // echo $factor ;?></td>-->
<!--                <td width="134"><?php // echo $convert2 ;?></td>-->
<!--                <td width="134"><?php // echo $convert1 ;?></td>-->
                <!--<td width="134"><?php // echo $venc;?></td>-->
	...
	<table width="100%" border="0" align="center"  id="customers">
               <tr>
                <?php if ($ckloc == 1){?><th width="30"><strong>LOCAL</strong></th><?php }?>
                 <th width="50"><div align="center"><strong>FECHA </strong></div></th>
                <th width="40"><div align="center"><strong>N&ordm; C. INTER </strong></div></th>
                <th width="55"><div align="right"><strong>N&ordm; FISICO </strong></div></th>
                <th width="90"><div align="center"><strong>CLIENTE </strong></div></th>
                <th width="40"><div align="center"><strong>DNI </strong></div></th>
                <?php if ($doc == 2){?><th align="center" width="<?php if ($doc == 2){?>40<?php } else {?>282<?php }?>"><strong>RUC</strong></th><?php }?>
            
 <th width="35">&nbsp;</th>
                <th width="25"><div align="center"><strong>AFECTO</strong></div></th>
                <th width="25"><div align="center"><strong>INAFECTO</strong></div></th>
                <th width="25"><div align="right"><strong>IGV</strong></div></th>
                <th width="30"><div align="right"><strong>TOTAL</strong></div></th>
            </tr>
      <?php while ($row = mysqli_fetch_array($result)){
		$invnum    = $row['invnum'];
		$usecod    = $row['usecod'];
