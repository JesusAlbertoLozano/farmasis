    ...
    <td>
        <table width="924" border="0">
            ...
            <tr>
                ...
                <td width="220"><div align="LEFT"><strong>PROVEEDOR/CLIENTE</strong></div></td>
    ...
    if (($tipmov == 1) || ($tipmov == 2))
    {
        ...
        if (mysqli_num_rows($result1)){
            while ($row1 = mysqli_fetch_array($result1)){
                $invnum         = (isset($row1['invnum']) ? $row1['invnum'] : "");
                $invnumrecib    = (isset($row1['invnumrecib']) ? $row1['invnumrecib'] : "");
                $usecod         = (isset($row1['usecod']) ? $row1['usecod'] : "");
                $cuscod         = (isset($row1['cuscod']) ? $row1['cuscod'] : "");
                $tipmovm        = (isset($row1['tipmov']) ? $row1['tipmov'] : "");
                $tipdocm        = (isset($row1['tipdoc']) ? $row1['tipdoc'] : "");
                $sucursal       = (isset($row1['sucursal']) ? $row1['sucursal'] : "");
                $sucursal1      = (isset($row1['sucursal1']) ? $row1['sucursal1'] : "");
            }
        }
    }
    if ($tipmovm == 1)    
...
////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////////
    ...
    $convert2 = $nsactual/$factor;
    $div2    	= floor($convert2);
    $UNI2 = ($nsactual-($div2*$factor));
?>
    <tr>
       ...
       <!--<td width="75"><div align="right"><?php echo $div2."C" ." ". $UNI2;?></div></td>-->
