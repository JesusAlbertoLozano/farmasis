                                    ...
                                    <div id="resultado" name="resultado" style="height: 100%;width:98%;">
                                        ...
                                        <form id="form1" name="form2" method = "post" action="">
                                            <table  align="center" style="border: solid 1px;width:98%;height:100%;margin: 25px;  " id="tabDetalle" name="tabDetalle" cellpadding="0" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql = "SELECT * FROM detalle_prepedido DP, titultabladet TI,producto P where DP.idprod=P.codpro AND TI.codtab=P.codmar    AND TI.tiptab='M' AND DP.numpagina = '$numpagina' AND  DP.solicitado <>'' AND  DP.solicitado <>'0' order by TI.destab, P.desprod ";
                                                    error_log($sql);
                                                    $result = mysqli_query($conexion, $sql);
                                                    $cont = 0;
                                                    if (mysqli_num_rows($result)) {
