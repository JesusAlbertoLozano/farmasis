...
<div class="pagina">
     ...
     <table width="100%"  height="50" border="0">
      ...
      <tr>
         ...
         <td class="letras121" height="35" colspan="2" width="633"><div class="letras121" align="center"><b> FECHAS ENTRE EL </b></div></td> 
      ...
      <tr>
          ...
          <td class="letras121" height="45" colspan="2" width="633"><div class="letras121" align="center"><b><?php echo $dat1; ?> Y EL <?php echo $dat2; } if ($valTipoDoc == 1){?> No DE DOCUMENTO ENTRE EL <?php echo $from; ?> Y EL <?php echo $until; } ?></b></div></td>
  ...
  <tr>
    <td>
      ...
      <tr>
		...
		<?php }?>
		<td width="<?php if ($ckloc == 1){?>200<?php } else{?>300<?php }?>" align="left" class="letras"><strong><h1>VENDEDOR</h1></strong></td>
	...
	<table width="100%" border="0" align="center">
		  ...
		  ?>
                        <tr bgcolor="#CCCCCC">
                               ...
                               -->
                                ...
                                <td colspan="5" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?> " width="57"><div align="right" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?> "><strong><h2>TOTAL</h2></strong></div></div></td>
                                <td  class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?> " width="260"><div align="right" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?> "><h2><pre><?php echo $numero_formato_frances = number_format($habil_tot1[$zz-1], 2, '.', ' ');?></pre></h2></div></td>

                        </tr>
	  <?php }?>
	  <tr >
        <?php if ($ckloc == 1){?><td  width="90" class="letras"><h1><?php echo $sucur?></h1></td><?php }?>
        <td colspan="5" align="left" class="letras" height="46px" ><h1><?php echo $user2?></h1></td>
      ...
      <!--
              ...
              -->
                ...
                <td class="<?php if ($ckloc == 1){?>letras22x<?php } else{?>letras1<?php }?>  " width="90"><div align="right" class="<?php if ($ckloc == 1){?>letras22x<?php } else{?>letras1<?php }?>  "><h2><pre><?php echo $numero_formato_frances = number_format($habil_tot, 2, '.', ' ');?></pre></h2></div></td>
		...
		<?php if ($zz == 1){?>
		  <table width="100%" border="0" align="center">
             ...
             -->
              ...
              <td colspan="5" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>  " width="57"><div align="right"class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>  "><strong><h2>  <?php if ($ckloc == 1){?> SUMA TOTAL <?php } else{?> TOT3<? }?></h2></strong></div></td>
              <td class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>  " width="260"><div align="right" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>  "><h2><pre><?php echo $numero_formato_frances = number_format($habil_tot1[$zz], 2, '.', ' ');?></pre></h2></div></td>
		  ...
		  <table width="100%" border="0" align="center">
            <tr bgcolor="#CCCCCC" >
             <!--
              ...
              <td colspan="5" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>" width="57"><div align="right"class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>"><strong><h2>TOTAL</h2></strong></div></td>
              <td class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>" width="260"><div align="right" class="<?php if ($ckloc == 1){?>letras22<?php } else{?>letras1<?php }?>"><h2><pre><?php echo $numero_formato_frances = number_format($habil_tot1[$zz], 2, '.', ' ');?></pre></h2></div></td>
