...
function validar1()
{
	  ...
	  { alert("Ingrese una Marca registrada en el Sistema"); f.country.focus(); return; }
	  if (f.date1.value == "")
	  ...
	  <form id="form1" name="form1" method = "post">
        ...
        <table width="928" border="0">
          <tr>
            ...
            <td>
			<input name="country" type="text" id="country" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event)" size="90" class="busk" value="<?php echo $country?>"/>
	    ...
	    <table width="928" border="0">
          <tr>
            ...
            <td width="133"><input type="text" name="date2" id="date2" size="12" value="<?php if ($date2 == ""){ echo $date;} else {echo $date2;}?>" /></td>
            <td width="80">Local</td>
			<td width="119"><select name="local" id="local">
				<?php
