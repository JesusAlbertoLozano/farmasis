                ...
                <td>
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td width="33%"><div align="center"><strong>REPORTE DE INGRESOS Y SALIDAS  </strong></div></td>
                            <td width="33%"><div align="center"><strong>FECHA: <?php echo date('d/m/Y'); ?> - HORA : <?php echo $hour; ?>:<?php echo $min; ?> <?php echo $hor ?></strong></div></td>
                        </tr>
                        <tr>
                ...
                <td>
                    ...
                    if (mysqli_num_rows($result)) {
                        ...
                        <table width="100%" border="0" align="center" id="customers">
                            <tr>
                                <th style="width: 2%"><div align="left"><strong>N&ordm;</strong></div></th>
                                <th style="width: 2%"><div align="left"><strong>CODIGO</strong></div></th>
                                <th style="width: 40%"><div align="left"><strong>PRODUCTO</strong></div></th>
                                <th style="width: 6%"><div align="left"><strong>MARCA</strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>LOTE </strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>VENCIMIENTO </strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>CANTIDAD</strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>COSTO</strong></div></th>
                                
                                <th style="width: 6%"><div align="center"><strong>DESC 1 </strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>DESC 2 </strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>DESC 3 </strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>TOTAL CON DCTO </strong></div></th>
                                <th style="width: 6%"><div align="center"><strong>SUB TOTAL </strong></div></th>
                            </tr>  
                            <?php
                            $i = 0;
                            while ($row = mysqli_fetch_array($result)) {
            ...
            while ($rowlo = mysqli_fetch_array($resultlo)){
                ...
                $vencim   = $rowlo['vencim'];
                                ...
                                <tr>
                                    ...
                                    <td ><div align="center"><?php echo $prisal ?></div></td>
                                    
                                    <td ><div align="center"><?php echo $desc1 ?></div></td>
                                    <td ><div align="center"><?php echo $desc2 ?></div></td>
                                    <td ><div align="center"><?php echo $desc3 ?></div></td>
                                    <td ><div align="center"><?php echo $pripro ?></div></td>
                                    <td ><div align="center"><?php echo $costre ?></div></td>
                                </tr>
                                <?php
                            }
                            $i++
