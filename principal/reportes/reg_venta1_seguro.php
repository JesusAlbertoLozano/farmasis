...
<td>
        ...
        <table width="990" border="0">
          <tr>
            ...
            <td width="50">NUEVO</td>
            <td width="150">
              <select name="doc2" id="doc2">
               
                <option value="0" <?php if ($doc2 == 0){?> selected="selected"<?php }?>>-------</option>
...
<!--                                      <input type="button" name="Submit" value="RESUMEN X DIA" onclick="resumen()" class="buscar"/>-->
			...
			<td width="24">
			  ...
			  {
			  ?>
              <a href="reg_venta.php?val=<?php echo $val?>&vals=<?php echo $vals?>&desc=<?php echo $desc?>&desc1=<?php echo $desc1?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&ck=<?php echo $ck?>&ck1=<?php echo $ck1?>&ckloc=<?php echo $ckloc?>&local=<?php echo $local?>&inicio=<?php echo $inicio?>&registros=<?php echo $registros?>&pagina=<?php echo $pagina-1?>"><img src="../../images/play1.gif" width="16" height="16" border="0"/> </a>
              <?php }
			  ?></td>
