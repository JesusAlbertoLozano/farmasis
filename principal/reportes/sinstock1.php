      ...
      <td><b><u>REPORTE DE PRODUCTOS NO VENDIDOS POR FALTA DE STOCK </u></b>
	    ...
	    <table width="928" border="0">
          <tr>
            ...
            <td width="23">&nbsp;</td>
            <td width="133"><div align="right">FECHA FINAL</div></td>
            <td width="149"><input type="text" name="date2" id="date2" size="12" value="<?php if ($date2 == ""){ echo $date;} else {echo $date2;}?>" /></td>
            <td width="156">&nbsp;</td>
