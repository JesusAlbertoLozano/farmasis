...
<?php require_once("local.php"); //OBTENGO EL NOMBRE Y CODIGO DEL LOCAL ?>
    ...
    $TipBusk 	= isset($_REQUEST['TipBusk'])? ($_REQUEST['TipBusk']) : "3";
...
<!--                                        <option <?php if ($TipBusk == 2) { ?>selected<?php } ?> value="2">Lo que se ha vendido y se agot&oacute</option>
                                ...
                                <td width="24">
                                    ...
                                    if (($pagina - 1) > 0) {
                                        ?>
                                        <a href="curv1.php?val=<?php echo $val ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&local=<?php echo $local ?>&inicio=<?php echo $inicio ?>&registros=<?php echo $registros ?>&pagina=<?php echo $pagina - 1 ?>"><img src="../../images/play1.gif" width="16" height="16" border="0"/> </a>
                                    <?php }
                                    ?></td>
                                <td width="24"><?php
                                    if (($pagina + 1) <= $total_paginas) {
                                        ?>
                                        <a href="curv1.php?val=<?php echo $val ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&local=<?php echo $local ?>&inicio=<?php echo $inicio ?>&registros=<?php echo $registros ?>&pagina=<?php echo $pagina + 1 ?>"> <img src="../../images/play.gif" width="16" height="16" border="0"/> </a>
                                    <?php }
                                    ?></td>
                            </tr>
                        </table>
