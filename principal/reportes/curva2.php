...
//$hour   = CalculaHora($hour);
    ...
    <body>
		...
		where DV.invfec between '$date1' and '$date2' and DV.codpro = '$codpro' and V.sucursal = '$local' and V.val_habil = '0' and V.estado = '0'";
                                    ...
                                    if ($Tabla <> "0") {
                                        $sql1 = "SELECT desprod,codmar,$Tabla,factor, s000,costre,codfam,blister,incentivado,codprobonif FROM producto where codpro = '$codpro'";
                                    } else {
                                        $sql1 = "SELECT desprod,codmar,stopro,factor, s000,costre,codfam,blister,incentivado,codprobonif FROM producto where codpro = '$codpro'";
                                    }
