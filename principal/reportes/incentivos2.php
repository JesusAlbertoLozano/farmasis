                ...
                if (mysqli_num_rows($results)) {
                    ?>
                                        <table width="926" border="0" align="center">
                                             <tr>
                            <th width="80"><strong>LOCAL</strong></td>
                            <th width="80"><div align="center"><strong>N&ordm; VENTA</strong></div></th>
                            <th width="80"><div align="center"><strong>N&ordm; DOCUMENTO</strong></div></th>
                            <th width="80"><div align="center"><strong>FECHA</strong></div></th>
                            <th width="497"><div align="left"><strong>VENDEDOR</strong></div></th>
                            <th width="50"><div align="center"><strong>COD. PROD</strong></div></th>
                             <th width="497"><div align="left"><strong>PRODUCTO</strong></div></th>
                            <th width="76"><div align="right"><strong>CANT VEND</strong></div></th>
                            <th width="76"><div align="right"><strong>PRECIO VTA</strong></div></th>
                            <th width="84"><div align="right"><strong>MONTO INCENT</strong></div></th>
                    </tr>
                                        <?php
                                                    ...
                                                    //if ($cantunid >= $totcunid) {
                                                        ...
                                                        if (($suc[$zz - 1] <> "") and ($suc[$zz - 1] <> $suc[$zz])) {  //////////LINEA 1
                                                            ...
                                                            <tr height="35"  <?php if($date2){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
                                                                ...
                                                                <td width="350" align="center"><?php echo $codpro2 ?></td>
