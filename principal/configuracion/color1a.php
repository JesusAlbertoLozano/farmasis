                ...
                <tr>
                  <td width="156" valign="top"><table width="146" border="0" align="center">
                    <tr>
                      ...
                      <td width="66">
					  <input name="text" type="text" id="dhtmlxColorPicker1" size="6" colorbox="true" value="<?php echo $primero ?>">
					  <script>
                  ...
                  <td width="157" valign="top"><table width="144" border="0" align="center">
                    <tr>
                      <td width="70">
					  <div align="center">
            ...
            <tr>
              <td width="589"><em>COLOR DE TEXTO              
                ...
                <table width="572" border="0">
                  <tr>
                    <td width="138">Productos con Stock Cero </td>
					<td width="28">
