...
<div class="mask1">
  <div class="mask2">
    <div class="mask3">
      ...
      <iframe src="local2.php?val=<?php echo $val?>&local=<?php echo $local?>&tip=<?php echo $tip?>&tipdocu=<?php echo $tipdocu?>" name="main" width="770" height="460" scrolling="Automatic" frameborder="No" id="main" allowtransparency="True"></iframe>
    </div>
  </div>
</div>
</body>
