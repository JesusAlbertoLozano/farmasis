...
//    selecionar nombre y digemid
	$sql="SELECT desprod,digemid FROM producto where stopro>0 and desprod like '$produc%' ";
	$result = mysqli_query($conexion,$sql);
	if (mysqli_num_rows($result)){
	while ($row = mysqli_fetch_array($result)){
		$desprod    = $row['desprod'];
...
<table width="943" border="0">
    <tr>
      <td width="835"><b><u>DIGEMID: </u></b>: Se mostraran los Productos para ingresar el codigo de digemid... </td>
      <td width="109">&nbsp;</td>
    </tr>
</table>
...
<!--	  <table width="943" border="0">
	  ...
	  <table width="943" border="0">
            ...
            <tr>
                ...
                <td width="529">
                            <input name="country" type="text" id="country" size="40" value="<?php echo $produc?>" onkeypress="return ent(event);"/>
                </td>
                <td width="350">
                    <div align="right">
                      <!--<input name="excel" type="button"  value="GENERA ARCHIVO EXCEL" onclick="popUpWindow()" class="buscar"/>-->
      ...
      <table width="943" border="0">
        <tr>
		  ...
		  <td width="342">
                    ...
                    <input name="search" type="button" id="search" value="TODOS LOS PRODUCTOS" onclick="TODOS()" class="buscar"/>
                    </div>
               </td>
          <td width="342">
		  <div align="right">
