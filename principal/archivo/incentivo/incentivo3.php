            ...
            if ($ord == "") {
                ...
                if ($val == 1) {
                    ...
                    if ($val == 2) {
                        ...
                        inner join incentivadodet on producto.codpro = incentivadodet.codpro 
                        inner join incentivado on incentivadodet.invnum = incentivado.invnum
                        WHERE incentivadodet.estado = 1 and incentivado.estado = 1 and incentivado.esta_desa = 0  order by desprod,$tabla $dtip LIMIT $inicio, $registros";
                    } 
                    else 
                    {
                        $sql = "SELECT codpro,desprod,incentivado,$tabla as stopro,codmar,factor FROM producto  where eliminado='0' order by desprod,$tabla $dtip LIMIT $inicio, $registros";
                    }
                }
            } else if ($ord == 2) {
                ...
                if ($val == 1) {
                    ...
                    if ($val == 2) {
                        ...
                        inner join incentivadodet on producto.codpro = incentivadodet.codpro 
                        inner join incentivado on incentivadodet.invnum = incentivado.invnum
                        WHERE incentivadodet.estado = 1 and incentivado.estado = 1 and incentivado.esta_desa = 0 order by incentivado,$tabla $dtip LIMIT $inicio, $registros";
                    } 
                    else 
                    {
                        $sql = "SELECT codpro,desprod,incentivado,$tabla as stopro,codmar,factor FROM producto  where eliminado='0' order by incentivado,$tabla $dtip LIMIT $inicio, $registros";
                    }
                }
