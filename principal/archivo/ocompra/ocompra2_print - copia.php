      ...
      <tr>
        ...
        <table width="914" border="0">
          <tr>
            <td width="176">&nbsp;</td>
            <td width="424">&nbsp;</td>
            <td width="300"><strong>Fecha de emisi&oacute;n  : <?php echo $invfec;?></strong></td>
          </tr>
        </table>
        <table width="914" border="0">
          <tr>
...
<table width="1019" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="1015"><table width="1009" border="0" align="center">
      <tr>
        <td width="100"><strong>C&oacute;digo</strong></td>
		<td width="137"><strong>Descripci&oacute;n</strong></td>
        <td width="75"><div align="right"><strong>VALOR VENTA </strong></div></td>
        <td width="54"><div align="right"><strong>DCTO1</strong></div></td>
        <td width="53"><div align="right"><strong>DCTO2 </strong></div></td>
        <td width="54"><div align="right"><strong>DCTO3</strong></div></td>
		<td width="54"><div align="right"><strong>T DCTO. </strong></div></td>
		<td width="83"><div align="right"><strong>CANT</strong></div></td>
		<td width="94"><div align="right"><strong>BONIFICACI&Oacute;N</strong></div></td>
		<td width="70"><div align="right"><strong>PRECIO</strong></div></td>
		<td width="60"><div align="right"><strong>FINAL</strong></div></td>
		<td width="67"><div align="right"><strong>MONTO</strong></div></td>
      </tr>
    </table></td>
  </tr>
</table>
<table width="1019" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="1009" border="0" align="center">
	  ...
	  ?>
	  <tr>
        <td width="101"><?php echo $codpro;?></td>
		<td width="136"><?php echo $desprod; echo " "; if ($costod == 0){?>(BONIF)
          <?php }?></td>
        <td width="75"><div align="right"><?php echo $precio_ref?></div></td>
        <td width="54"><div align="right"><?php echo $desc1?></div></td>
        <td width="53"><div align="right"><?php echo $desc2?></div></td>
        <td width="54"><div align="right"><?php echo $desc3?></div></td>
        <td width="54"><div align="right"><?php echo $desc5?></div></td>
		...
		<td width="70"><div align="right"><?php echo $desc3?></div></td>
		<td width="60"><div align="right"><?php echo $pfinal?></div></td>
		<td width="67"><div align="right"><?php echo $mont_total?></div></td>
      </tr>
	  <?php }
	  //////////CALCULO DEL IGV
