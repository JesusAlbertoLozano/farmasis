...
<body <?php ?>onload="sf();" <?php ?>>
    ...
    <iframe src="precios2.php?search=<?php echo $search ?>&val=<?php echo $val ?>&ckM=<?php echo $ckM ?>" name="marco" id="marco" height="450" scrolling="Automatic" frameborder="0" allowtransparency="0">
    </iframe>
</body>
