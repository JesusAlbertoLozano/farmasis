...
//	$price1	= isset($_REQUEST['price1']) ? ($_REQUEST['price1']) : "";			//costre
	...
	if ($val == 2)
	{
			...
			$sql="SELECT codpro,desprod,codbar,costre,factor,stopro,SUM(s000+s001+s002+s003+s004+s005+s006+s007+s008+s009+s010+s011+s012+s013+s014+s015+s016+s017+s018+s019+s020) as sumato FROM producto where codpro = '$codigo'";
			$result = mysqli_query($conexion,$sql);
			if (mysqli_num_rows($result) ){
			while ($row = mysqli_fetch_array($result)){
