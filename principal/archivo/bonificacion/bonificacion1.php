...
<table width="943" border="0">
    <tr>
      <td width="835"><b><u>BONIFICACI�N DE PRODUCTOS: </u></b>: Se mostraran los Productos para configurar sus bonificaciones. </td>
      <td width="109">&nbsp;</td>
    </tr>
</table>
...
<iframe src="bonificacion2.php?search=<?php echo $search?>&val=<?php echo $val?>" name="marco" id="marco" width="954" height="450" scrolling="Automatic" frameborder="0" allowtransparency="0">
</iframe>
</body>
</html>
