                ...
                <td width="580"><label>
                    <div align="right">
                      ...
                      <input name="modif" type="button" id="modif" value="Modificar" class="modificar" disabled="disabled" onclick="modificar()"/>
											...
											<?php if ($val_habil == 1) {?>
					  <input name="del" type="button" id="del" value="Activar" class="eliminar" <?php if (($codgrup <>2) and ($val_habilmoante<> 0) and ($estadoante <>0) ){?>disabled="disabled" <?php }?>  <?php if ($val_habilmoante == 0){ ?> onclick="habilitaring()"<?php } else { $stringAlert22 = "onclick=\"alert('$msg_habil_anterio');\""; 	echo $stringAlert22; } ?> />
					  <?php } else {?>
						<?php if ($est_habil_stock==1) {
							?>
							<input  name="del1" type="button" id="del1" value="Anular" class="eliminar" <?php if ($codgrup <>2){?>disabled="disabled" <?php }?> onclick="eliminaring()"/>
							<?php
						} else {
							?>
