...
while ($row = mysqli_fetch_array($result)){
	...
	/*	echo $cod."<br>";
		...
		/////////////////////////////////////////////////////////////
		mysqli_query($conexion,"INSERT INTO kardex (nrodoc,codpro,fecha,tipmov,tipdoc,qtypro,fraccion,factor,invnum,usecod,sactual,sucursal, eliminado) values ('$numdoc','$codpro','$fechaActual','1','2','$qtypro','$qtyprf','$factor','$cod','$usuario','$sactual','$sucursal','1')")	;
}
}
