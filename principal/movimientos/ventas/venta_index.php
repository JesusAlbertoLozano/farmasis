            ...
            <div class="mask2222" style="height:auto;">
                <div class="mask3333" style="height:auto;">
                    ...
                    <div class="contenedor-responsivo">
                        <iframe class="iframe-responsivo" src="venta_index1.php?activado=<?php echo $activado; ?>&activado1=<?php echo $activado1; ?>&tipo=<?php echo $tipo; ?>&val=<?php echo $val; ?>&producto=<?php echo $producto; ?>" gesture="media" allow="encrypted-media" allowfullscreen id="venta_principal" name="venta_principal" scrolling="no" allowtransparency="0" frameborder="0"></iframe>
                    </div>
 -->
