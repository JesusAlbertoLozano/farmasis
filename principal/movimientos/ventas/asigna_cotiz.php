        ...
        if ($baja == 0) {
            ...
            if (mysqli_num_rows($resultx)) {
                ...
                while ($rowx = mysqli_fetch_array($resultx)) {
                    ...
                    $sqly = "SELECT preuni,$tabla,pcostouni,codpro,prevta  FROM producto where codpro = '$codpro'";
                    ...
                    if (mysqli_num_rows($resulty)) {
                        while ($rowy = mysqli_fetch_array($resulty)) {
                            ...
                            if (($zzcodloc <> 1) && ($precios_por_local == 1)) {
                                ...
                                $sql_precio = "SELECT $pcostouni_p,$preuni_p,$prevta_p  FROM precios_por_local where codpro = '$codpro'";
