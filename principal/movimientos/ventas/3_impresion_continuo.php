    ...
    <div class="div_continuo_1" style="width: 100%">
        <div class="div_continuo_2">
            <table border="0" width="100%">
                <tr>
                    <td class="letra_continuo" width="55px"> <p class="letra_continuo">Feha: </p></td>
                    <td class="letra_continuo"> <p class="letra_continuo"> <?php echo $invfec; ?></p></td>
                    <td class="letra_continuo" width="100px"> <p class="letra_continuo">Vendedor: </p></td>
                    <td class="letra_continuo"> <p class="letra_continuo"> <?php echo $nomusu; ?></p></td>
                </tr>
                <tr>
                    <td class="letra_continuo"><p class="letra_continuo">Hora:</p></td>
                    <td class="letra_continuo"><p class="letra_continuo"> <?php echo substr($hora, 0, 5); ?></p></td>
                    <td class="letra_continuo"><p class="letra_continuo">Documento:</p></td>
                    <td class="letra_continuo"><p class="letra_continuo"> <?php echo $nrofactura; ?></p></td>
                </tr>
            </table>
        </div>
    </div>
