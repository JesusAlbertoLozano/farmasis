...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
    ...
    if ($count == 0) {
       ...
       mysqli_query($conexion, "UPDATE venta set n_cotizacion = '0',cuscod='$codcli',codmed='0',forpag='E',numeroCuota='0'   where invnum = '$venta'"); ///controla bonificaciones
    }
...
*/
    ...
    if ($usuariosEspeciales_ArqueoCaja == 1) {
        ...
        if (($usuario == '1') || ($usuario == '2') || ($usuario == '7742')) {
            $bloqueoUsuario = '1';
        } else {
            $bloqueoUsuario = '0';
        }
