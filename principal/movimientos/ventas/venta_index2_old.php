...
<head>
    ...
    if ($count == 0) {
        ...
        mysqli_query($conexion, "UPDATE venta set n_cotizacion = '0',cuscod='$codcli',codmed='0' where invnum = '$venta'"); ///controla bonificaciones
    }
    ...
    $sqlVenta = "SELECT sucursal,forpag FROM venta where invnum = '$venta'";
        ...
        <table width="100%" height="30" border="0" class="tabla2">
            ...
            <tr>
                <td width="60%" colspan="2">
                    <input type="button" class="grabar" name="Submit" value="Asignar m&eacute;dico (F1)" onclick="f1();" class="grabar" />
                    <input type="button" class="grabar" name="Submit" value="Asignar cliente (F2)" onclick="f2();" />
                    <input type="button" class="grabar" name="Submit" value="Forma de pago (F6)" onclick="f6();" />
                    <input type="button" class="grabar" name="Submit" value="Ver Incentivos(F11)" onclick="incentiv();" />
                    <?php if ($arqueo == 1) { ?>
                        <blink>
                ...
                <td width="40%" valign="middle">
                    <div align="right">
                        ...
                        &nbsp;
                        <input name="veb" type="button" id="veb" value="GRABAR VENTA(F9)" onclick="grabar1()" class="grabar" <?php if (($count == 0) || ($count1 > 0)) { ?>disabled="disabled" title="Necesita escoger un producto para activar la Opcion GRABAR VENTA(F9)" <?php } ?> />
        ...
        <div style="margin-top: 10px">
            ...
            <table width="100%" border="0">
                <tr>
                    <td width="20%">
                        <div align="center">
                            <strong>MONTO BRUTO : </strong><input name="mont1" class="sub_totales" type="text" id="mont1" onclick="blur()" size="15" value="<?php if ($count2 > 0) { ?> <?php echo $numero_formato_frances = number_format($valor_vent1, 2, '.', ' '); //echo $numero_formato_frances = number_format($mont_bruto, 2, '.', ' ');                                                               
                                                                                                                                                                                        ?> <?php } else { ?>0.00<?php } ?>" />
                        </div>
                    </td>
                    <td width="20%">
