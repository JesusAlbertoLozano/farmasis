...
$arqueo_arqueo_no_cerraron_dias_antes="";
    ...
    if (isset($_SESSION['venta'])) {
        ...
        $sql = "SELECT invnum,cuscod,invfec,nrovent,correlativo,ndias,delivery,forpag,n_cotizacion,deliveryWeb FROM venta where invnum = '$sessionVenta' and usecod = '$usuario' and estado ='1'";
    } else {
        ...
        $sql = "SELECT invnum,cuscod,invfec,nrovent,correlativo,ndias,delivery,forpag,n_cotizacion,deliveryWeb FROM venta where invnum = '$lastVentaId' and usecod = '$usuario' and estado ='1'";
    }
                ...
                <td width="100%">
                    ...
                    <table width="100%" style="margin-top:-25px;margin-bottom:-9px;" border="0">
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <input class="inpu" name="fpago" id="fpago_prueba" type="text" onkeypress="return forma_pago(event);" onkeyup="cargarContenido()" size="2" maxlength="1" value="<?php echo $forpag; ?>" />
                                <label title="E = EFECTIVO / C = CREDITO / T = TARJETA ">
                                    (E, C, T) &nbsp;&nbsp;&nbsp;
                                </label>
                            ...
                            <td width="7%">
                                ...
                                <input name="delivery" type="checkbox" id="delivery" value="1" <?php if ($delivery == 1) { ?>checked="checked" <?php } ?> <?php if ($deliveryWeb == 1) { ?>disabled="disabled" <?php } ?>onclick="Validardelivery();" />
                              ...
                              <td width="10%">
                                <label for="deliveryWeb"><strong>DELIVERY WEB</strong></label>
