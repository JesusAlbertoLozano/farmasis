...
<script language="JavaScript">
    ...
    function Validardelivery() {
       // document.getElementById("deliveryWeb").style.display="none";esto es para ocultar? lo piuse probando pero no funciono, dejame buscar como ocultar o mejor agregar una clase, crear la clase .gris-color{color:gris}
        // document.form1.deliveryWeb.style.visibility="hidden"; 
