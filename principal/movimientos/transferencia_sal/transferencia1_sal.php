...
//			  { alert("Ingrese una referencia"); f.referencia.focus(); return; }
			 /* if (f.vendedor.value == 0)
			  ...
			  if (confirm("Ã¯Â¿Â½Desea Grabar esta informacion?")) {
 ...
 function grabarventa()
    {
        var f = document.form1;
			  ...
			  if (f.local.value == 0)
			  {
			  alert("Seleccione un Local Destino"); f.local.focus(); return; 
			  }
			  if (f.vendedor.value == 0)
			  {
      ...
      <td width="958">
          ...
          <table width="100%" border="0">
            <tr>
			  ...
			  <option value="0">Seleccione un Local...</option>
                ...
                if(($cargaprepedido <> 0)&&( $count2 <> 0)){
                    $sql = "SELECT * FROM xcompa where codloc <> '$codigo_local' and habil = '1' and codloc = '$localrecargado' order by nombre, nomloc"; 
                }else{
                    $sql = "SELECT * FROM xcompa where codloc <> '$codigo_local' and habil = '1' order by nombre, nomloc"; 
                }
				$result = mysqli_query($conexion,$sql); 
				while ($row = mysqli_fetch_array($result)){ 
				        $loc    = $row['codloc'];
		     ...
		     <td width="350"><div align="left" class="text_combo_select"><strong>USUARIO :</strong> <img src="../../../images/user.gif" width="15" height="16" /> <?php echo $user?></div></td>
            ...
            <tr>
              ...
              <td width="868" colspan="5">
			    <input name="referencia" type="text" id="referencia" size="139" onkeyup="cargarContenido()" value="<?php echo $refere;?>" placeholder="Ingrese una referencia o transportista...."/></td>
                <input type="hidden" id="doc" name="doc" value="<?php echo $numdoc; ?>" />
            </tr>
            
            <tr>
                <td width="150" class="LETRA" align="left">CARGAR PREPEDIDO</td>
            <td width="200">
			  				<input name="prepedido" type="text" id="prepedido" size="17" value="<?php  if($cargaprepedido == 0){echo "" ;}else{ echo $cargaprepedido;}?>"/>
		  ...
		  <table width="100%" border="0" align="center">
            <tr>
              ...
              <td width="49"><div align="right"></div></td>
              <td width="80">&nbsp;</td>
              <td width="125"><div align="right" class="LETRA">PRECIO DE SALIDA </div></td>
              <td width="113">
			    <div align="right">
              ...
              <td width="57"><div align="right" class="LETRA">TOTAL</div></td>
              <td width="108">
			    <div align="right">
