...
while ($row = mysqli_fetch_array($result)){
		...
		$date   = date('Y-m-d');
		$sqlInsert = "INSERT INTO kardex (nrodoc,codpro,fecha,tipmov,tipdoc,qtypro,fraccion,factor,invnum,usecod,sactual,sucursal, eliminado) values ('$numdoc','$codpro','$fechaActual','1','1','$qtypro','$qtyprf','$factor','$cod','$usuario','$sactual','$sucursal','2')";
		error_log($sqlInsert);
