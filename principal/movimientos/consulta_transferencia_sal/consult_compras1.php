                                                ...
                                                <div align="right">
                                                    ...
                                                    <?php if ($val_habil == 1) { ?>
                                                        <?php if ($est_habil_stock == 1) { ?>															
                                                            <input name="habilitar_salida" type="button" id="habilitar_salida" value="Habilitar" class="eliminar" <?php if ($codgrup <> 2) { ?>disabled="disabled" <?php } ?> onclick="habilitar_salida1()"/>																							
                                                            <?php
                                                        } else {
                                                            ?>
