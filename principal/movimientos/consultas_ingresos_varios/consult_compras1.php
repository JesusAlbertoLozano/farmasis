                                    ...
                                    <tr>
                                        ...
                                        <td width="580"><label>
                                                <div align="right">
                                                    ...
                                                    <?php if ($val_habil == 1) { ?>
                                                        <input name="habilitar_ingreso" type="button" id="habilitar_ingreso" value="Activar" class="eliminar" title=" <?php echo  '$find Activar '.$find ?> " <?php if ($find <> 1) { ?>disabled="disabled"  <?php } ?> onclick="habilitar_ingreso1()"/>
                                                    <?php } else { ?>
                                                        <?php if ($est_habil_stock == 1) {
                                                            ?>
                                                            <input name="anular_ingreso" type="button" id="anular_ingreso" value="Anular" class="eliminar" title=" <?php echo  '$find Anular '.$find ?> " <?php if ($find <> 1) { ?>disabled="disabled" <?php } ?> onclick="anular_ingreso1()"/>
                                                            <?php
                                                        } else {
                                                            ?>
