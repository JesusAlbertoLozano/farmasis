...
<table width="98%" border="0">
  <tr>
    ...
    <td width="7%"><div align="right">Revate</div></td>
     <td width="7%"><div align="right">P.Vta Uni</div></td>
    <td width="7%"><div align="right">Sub Total</div></td>
...
<?php 
	...
	while ($i >= 0){
		...
		$d2        = $row1['desc2'];
		$d3        = $row1['desc3'];
		$sql2="SELECT desprod,preuni,prevta FROM producto where codpro = '$codpro'";
...
<table width="98%" border="0">
  <tr>
      <td width="7%"><div align="right"><?php echo $codpro?></div></td>
    ...
    <td width="7%"><div align="right">0.00</div></td>
     <td width="7%"><div align="right"><?php echo $prevta?></div></td>
    <td width="7%"><div align="right"><?php echo $total?></div></td>
