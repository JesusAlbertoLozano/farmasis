...
while ($row = mysqli_fetch_array($result)){
		...
		$sqlKardex = "INSERT INTO kardex (codpro, nrodoc, tipmov, tipdoc, fecha, qtypro,fraccion,factor, invnum,usecod,sactual,sucursal, eliminado) VALUES('$codpro', '$numdoc', '2', '1', '$invfec','$qtypro','$qtyprf','$factor','$cod','$usuario','$sactual','$sucursal', '3')";
		error_log($sqlKardex);
