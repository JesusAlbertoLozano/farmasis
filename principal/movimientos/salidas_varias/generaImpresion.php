...
<body onload="imprimir()">
    ...
    $Sucursal   = "";
    $Proveedor  = "";
    $sqlCompras = "SELECT numdoc,invfec,usecod,refere,sucursal,cuscod,forpag,numero_documento,numero_documento1,incluidoIGV,plazo,fecven,invtot,igv,valven,destot,costo FROM movmae where invnum = '$CCompra'";
    ...
    ?>
        <table style="width: 100%">
            <tr>
                ...
                <td colspan="9">INGRESOS VARIOS</td>
            </tr>
            <tr>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <th style="text-align:right">Pre Promedio</th>
