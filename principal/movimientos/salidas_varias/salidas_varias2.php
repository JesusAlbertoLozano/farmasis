...
var key = nav4 ? evt.which : evt.keyCode;
	...
	else
	{
		...
		if (valor == true)
		{
    		...
    		var v1xx = document.form1.text1.value.substring(1);
    		if (v1xx>v3)
		...
		else
		{
		    ...
		    v1x = v1 * factor;		////avisa que es numero
...
var key = nav4 ? evt.which : evt.keyCode;
	...
	else
	{
		...
		{
		//var porcion = v1.substring(1); // porcion = "ndo"
		var v1cc = document.form1.text1.value.substring(1);
		...
		{
		v1ffw = v1 * factor;		////avisa que es numero
  ...
  <table class="celda2" width="910">
	...
	?>
	 <tr onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';">
      ...
      <td width="17"><div align="center"><?php if ($control == 0){ if ($cant_loc > 0) {?> <a href="transferencia2_sal_reg.php?cod=<?php echo $codpro?>" target="comp_principal"></a><?php }}else{?><img src="../../../images/icon-16-checkin.png" width="16" height="16" border="0"/><?php }?></div></td>
    </tr>
	<?php }
	?>
  </table>
