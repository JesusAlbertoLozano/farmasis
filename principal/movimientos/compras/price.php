...
$sql="SELECT desprod,factor,margene,prevta,preuni,tcosto,tmargene,tprevta,tpreuni,costpr FROM producto where codpro = '$cod'";
    ...
    <tr>
      <td width="540"><table width="444" border="0" align="center">
        ...
        <tr>
          ...
          <td bgcolor="#FFFFCC"><input name="price" type="text" id="price" onkeypress="return decimal(event)" onkeyup="precio();" value="<?php if ($costo <> 0){ echo $costo;} else { echo $tcosto;}?>"/> 
            (Incluido IGV) </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td bgcolor="#FFFFCC">
		  <input name="priceU" type="text" id="priceU" onkeypress="return decimal(event)" value="<?php if ($tmargene <> 0){ echo $tmargene;} else { echo $margene;}?>" onkeyup="precioUni();"/></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> PRECIO VTA.  </span></td>
          <td bgcolor="#FFFFCC"><input name="price2" type="text" id="price2" onkeypress="return decimal(event)" value="<?php if ($tprevta <> 0){ echo $tprevta;}?>" onkeyup="precio1();"/></td>
        </tr>
        <tr>
          <td><span class="Estilo5"> PRECIO VTA. UNIT </span></td>
          <td bgcolor="#FFFFCC">
            <input name="price3" type="text" id="price3" onkeypress="return decimal(event)" value="<?php if ($tpreuni <> 0){ echo $tpreuni;}?>" onkeyup="precioUni1();"/>
