...
if(isset($_REQUEST['getCountriesByLetters']) && isset($_REQUEST['letters'])){
	...
	if($t == 0)
	{
            $res = mysqli_query($conexion,"select codpro,factor,desprod,$columna,codmar,stopro from producto where activo1 = '1' and desprod like '".$letters."%' limit $limit") or die(mysqli_error());
	}
	else
	{
            $res = mysqli_query($conexion,"select codpro,factor,desprod,$columna,codmar,stopro from producto where activo1 = '1' and codpro like '".$letters."%' limit $limit") or die(mysqli_error());
	}
