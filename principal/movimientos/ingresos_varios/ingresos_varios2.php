...
<body onload="  <?php if ($valcprod == 0) { ?> sf();<?php } else {
    ...
    <form id="form1" name="form1" onKeyUp="highlight(event)" onClick="highlight(event)" method="post">
        ...
        if ($val == 1) {
            if ($Desprod <> "") {
                ...
                if ($EsCodigoProducto == 0) {
                    $sqlSProd = "SELECT codpro,desprod,codmar,factor,igv,pcostouni,$lotenombre as lote ,costre,$tablad as local,codpro,preuni,prevta FROM producto where activo1 = '1' and eliminado='0' and (desprod LIKE '$Desprod%')   order by desprod" or die(mysqli_error());
                } else {
                    $sqlSProd = "SELECT codpro,desprod,codmar,factor,igv,pcostouni,$lotenombre as lote,costre,$tablad as local,codpro,preuni,prevta FROM producto where activo1 = '1' and eliminado='0' and ((codpro = '$Desprod') || (codbar = '$Desprod'))  order by desprod" or die(mysqli_error());
                }
        ...
        ?>
                    <table width="100%" id="customers" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <th width="100">Precio Venta (Unitario)</th>
                            <th width="100">Precio Venta (Caja)</th>
                            
                            <th width="70">Stock Local</th>
        ...
        if ($val == 2) {
            ...
            $sql = "SELECT codpro,desprod,codmar,$tabla,$lotenombre as lote,costre,preuni,prevta FROM producto where activo1 = '1' and codpro = '$producto' order by desprod";
            $result = mysqli_query($conexion, $sql);
            if (mysqli_num_rows($result)) {
                ?>
                ...
                <table id="customers" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <?php } ?>
                            ...
                            <th width="68">
                            <div align="CENTER">PRECIO VENTA </div>
                        </th>
                        <th width="76">
                            <div align="CENTER">COSTO REPOSICIÓN</div>
                        </th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div align="right">
                                    <?php if (($valform == 1) && ($cprod == $codpro)) { ?>
                                        ...
                                        <!--el valor lo cambias-->
                                        <input name="prevta" type="hidden" id="prevta" value="<?php echo $prevta; ?>" />
                                        <input name="preuni" type="hidden" id="preuni" value="<?php echo $preuni; ?>" />
                            ...
                            <td title="22222">
                                <div align="right">
                                    <?php if (($valform == 1) && ($cprod == $codpro)) { ?>
                                        <input name="text2" type="text" id="text2" value="<?php echo $prevta; ?>" size="4" onKeyPress="return ent1(event)" readonly />
