        ...
        <form id="form1" name="form1" onKeyUp="highlight(event)" onClick="highlight(event)">
            ...
            <table id="customers" cellpadding="0" cellspacing="0">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    $sql1 = "SELECT desprod,codmar,factor,pcostouni,stopro,$tabla, $lotenombre as lote,codpro,preuni,prevta,costre FROM producto where codpro = '$codpro'";
                    $result1 = mysqli_query($conexion, $sql1);
                    if (mysqli_num_rows($result1)) {
                        while ($row1 = mysqli_fetch_array($result1)) {
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td width="74" valign="bottom">
                            <div align="right">
                                <?php if (($valform == 1) && ($cod == $codpro) && ($codtempfiltro == $codtemp)) { ?>
                                    <input name="text2" type="text" id="text2" size="4" class="pvta" value="<?php echo $costre1; ?>" onclick="blur()" />
                                <?php
                                } else {
                                    echo $costre1;
                                }
