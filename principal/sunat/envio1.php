                ...
                <td>
                    ...
                    <form id="form1" name="form1" method="post">
                        ...
                        <table class="rodrigo-table-form" border="0" width="100%">
                            <tr>
                                <td valign="top" width='50px'>Fecha</td>
                                ...
                                <td valign="top" colspan="2" width='50px' >                                    
                               ...
                               <td>
                                ...
                                <td valign="top">
                                    <select id="typesummary" name="typesummary">
                                        ...
                                        <!--                                        <option value="anullncfactura">Comunicaci�n Baja de Notas de Facturas</option>-->
                                    </select>
...
<!--                                    <th width="65px">Anulado Sistema</th>-->
        ...
        <script type="text/javascript">
            ...
            $('#sunat-resumen').on('click', function () {
                ...
                var sucursal = $('#sucursal').val();
                if (date.length > 0 && sucursal.length > 0) {
                    if (confirm('Esta apunto de generar una comunicacion de baja para enviar a SUNA. ¿Desea continuar?')) {
                        $.ajax({
                            type: 'POST',
