...
//$sql = "SELECT invnum  FROM venta WHERE sunat_respuesta_descripcion LIKE '%Debe consignar el Total%' ORDER BY invnum ";
  //$sql = "SELECT invnum FROM venta WHERE sunat_respuesta_descripcion LIKE '%El importe total%' ORDER BY invnum";
  $sql = "SELECT invnum,igv  FROM venta WHERE invnum='4010482' and estado=0 ORDER BY invnum ";
