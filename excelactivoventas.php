...
<head>
    ...
    <title>Reporte de productos no activo para ventas con stock</title>
...
<body>
    ...
    $i = 0;
   $sqlDetalleVenta = "SELECT * FROM `producto` where activo='0' and stopro > 0 and eliminado='0' ";
        ...
        <table border='1' width="100%" align="center" id="customers">
            ...
            <thead>
                 <tr>
                    <th colspan='30'>
                        <h1>
                         REPORTE DE PRODUCTOS NO ACTIVOS PARA VENTAS CON STOCK
                        </h1>
                    </th>
                </tr>
                <tr>
